...
if __name__ == '__main__':
    ...
    parser.add_argument('--SoccerNet_path',   required=False, type=str,   default="/data1/SoccerNet/R152_5fps",     help='Path for SoccerNet' )
    ...
    parser.add_argument('--config_file', type=str, default='/workspace/GEBD/SoccerNetv2-DevKit/Task2-CameraShotSegmentation/EffGEBD/baseline.yaml')
    ...
    model_save_path = '/workspace/GEBD/SoccerNetv2-DevKit/Task2-CameraShotSegmentation/EffGEBD/' + \
