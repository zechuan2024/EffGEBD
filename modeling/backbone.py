...
class CSN(nn.Module):
    def __init__(self):
        super().__init__()
        config_path = 'EfficientGEBD/configs/CSN-configs/R152/ircsn_ig65m-pretrained-r152-bnfrozen_8xb12-32x2x1-58e_kinetics400-rgb.py'
        ...
        checkpoint_path = 'EfficientGEBD/csn-ckpt/R152/ircsn_from_scratch_r152_ig65m_20200807-771c4135.pth'
...
class CSNR50(nn.Module):
    def __init__(self):
        super().__init__()
        config_path ='EfficientGEBD/configs/CSN-configs/R50/ircsn_ig65m-pretrained-r50-bnfrozen_8xb12-32x2x1-58e_kinetics400-rgb.py'
        ...
        checkpoint_path ='ZZC/EfficientGEBD/csn-ckpt/R50/ircsn_from_scratch_r50_ig65m_20210617-ce545a37.pth'
