...
def main(cfg, args):
    ...
    saved_py = ['modeling/e2e_model_diff_former.py', 'modeling/diff_former.py', 'modeling/resnet.py', \
                'modeling/baseline.py', 'post_process.py', 'train.py', 'configs/e2e/baseline_end_to_end_diff_former.yaml', \
                'datasets/dataset.py', 'utils/eval.py', 'train.sh']
    for py in saved_py:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--config-file", type=str, default='configs/e2e/baseline.yaml')
